      ...
      <div className="max-w-6xl mx-auto space-y-24 px-6 md:px-12 pb-24 pt-32">
        ...
        <section className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <h3 className="text-sm font-mono text-muted-foreground uppercase tracking-widest pl-1">Impact // Global</h3>
          ...
          <div className="space-y-4">
            <div className="w-12 h-[1px] bg-foreground/20 mb-6" />
            <h3 className="text-sm font-mono text-muted-foreground uppercase tracking-widest pl-1">Status // Live</h3>
